...
public class GUIManager : MonoBehaviour 
{
    ...
    public Transform BackPack;                           //The BackPack parent object
...
//		if(CTLevelProgress.pInstance == null || CTLevelProgress.pInstance.pCurrentLevel != 0)
    ...
    public void ReceiveInput(Transform button)
    {
        ...
        switch (button.name)
        {
            ...
            case "BackPackButton":
                BackPackManager.Instance.ButtonPressed();
                break;

            case "Restart":
                LevelDesignManager.Instance.RestartScene();
                break;
    ...
    void PlayLevel()
    {
        ...
        //Change play button texture, enable the level objects, and hide the BackPack
        playButton.GetComponent<SpriteRenderer>().sprite = playButtonTextures[1];
        LevelDesignManager.Instance.EnableScene();
    ...
    void StopLevel()
    {
        ...
        //Reset the level and show the BackPack
        playButton.GetComponent<SpriteRenderer>().sprite = playButtonTextures[0];
        LevelDesignManager.Instance.ResetScene();
        BackPackManager.Instance.ShowBackPack();
    ...
    void PauseLevel()
    {
        ...
        //Hide the BackPack and fade the screen
        BackPackManager.Instance.HideBackPack();
    ...
    void UnpauseLevel()
    {
        ...
        //Show the BackPack and unfade the screen
        BackPackManager.Instance.ShowBackPack();
    ...
    void RestartFromFinish()
    {
        ...
        StopLevel();
        LevelDesignManager.Instance.RestartFromFinish();
    }
    ...
    IEnumerator ShowFinishScreen()
    {
        ...
        LevelDesignManager.Instance.SaveData();
        int stars = LevelDesignManager.Instance.GetStarsCollected();
